...
\begin{figure}[hbt!]
\centering
\includegraphics[height=2in]{./Images/map1-Viesata}
\caption{Map of the Viesata River Bends trail, one of the more challenging locations for WSN application. Much of the trail follows the prominent ravine carved by the flow of the river, the banks of which are sheer inclines up to around 10 meters in height and covered in dense vegetation.}
\end{figure}
